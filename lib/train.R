...
train<-function(dat_train,label_train) {
  ...
  save(err_cv, file="C:/Users/YounHyuk/Desktop/Project3_poodleKFC_train/output/err_train_baseline11.RData")
  ...
  save(fit_train, file="C:/Users/YounHyuk/Desktop/Project3_poodleKFC_train/output/fit_train_baseline11.RData")
  print(err_cv)
  print(depth_best)
  return(fit_train)
...
system.time(result<-train(dat_train,label_train))
